...
import { User, Settings, LogOut, Edit3, Save, X, Bell, Shield, Palette } from 'lucide-react';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{userInfo.location}</p>
                  )}
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 bg-gray-50 px-3 py-2 rounded-lg">{userInfo.bio}</p>
                  )}
                </div>
              </div>
            </div>
