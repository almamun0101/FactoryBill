...
const page = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 px-4 py-3 pb-24">
      <div className="max-w-5xl mx-auto space-y-12">
        {add && (
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            <div className="flex justify-between items-center bg-gradient-to-r from-blue-600 to-indigo-600 p-6">
              <div className="flex items-center gap-3">
                ...
                <div className="">
                <button onClick={()=>setAdd(!add)} className="text-white">
                    Cancel
                </button>
              </div>
            </div>
            ...
            <div className="p-5 space-y-2">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full border-2 border-gray-200 p-2 rounded-xl text-gray-800 
                            focus:border-blue-500 focus:ring-4 focus:ring-blue-100 
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white 
                          px-6 py-2 rounded-xl hover:from-blue-700 hover:to-indigo-700 
        ...
        {!add && (
          <section className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden">
            {/* Table Header */}
            <div className="flex  justify-between items-center bg-gradient-to-r from-gray-900 to-gray-800 p-6">
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-4 gap-4 p-3 bg-gray-50 rounded-xl font-semibold text-gray-700 mb-4">
                ...
                <div className="flex items-center gap-2">
                  <Zap className="h-4 w-4 text-yellow-600" /> Money
                </div>
              </div>
              ...
              <div className="space-y-3">
                {data.map((item, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="grid grid-cols-4 gap-4 p-3 rounded-xl border border-gray-200 
